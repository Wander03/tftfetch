structure(list(method = "GET", url = "https://americas.api.riotgames.com/riot/account/v1/accounts/by-riot-id/123/HENRO", 
    status_code = 401L, headers = structure(list(date = "Sun, 13 Jul 2025 02:00:21 GMT", 
        ...
        server = "cloudflare", `cf-ray` = "95e52fb1288d2712-SJC"), redact = character(0), class = "httr2_headers"), 
