httptest2::with_mock_dir("fixtures/account_by_puuid", {
  ...
  test_that("get_account_by_puuid handles invalid inputs gracefully", {
    ...
    expect_error(get_account_by_puuid(puuid = 123, routing_region = "americas", api_key = "MOCKED_API_KEY"))
    ...
    expect_error(
      get_account_by_puuid(puuid = "NonExistentPuuid", routing_region = "americas", api_key = "MOCKED_API_KEY"),
